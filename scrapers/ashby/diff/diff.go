...
func DetectChanges(normalizedJobs []*common.JobPayload, company string) []common.Change {
	...
	removed, _ := db.MarkRemovedJobs(company, currentActiveJobIds)
